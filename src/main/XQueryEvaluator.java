...
public class XQueryEvaluator extends XQueryBaseVisitor<List<Node>> {
    ...
    public List<Node> visitFLWR(XQueryParser.XqContext ctx) {
        if (ctx == null) {
            System.out.println("Condition context is null!");
            return new ArrayList<>();
        }
    ...
    public List<Node> visitBindings(int idx, XQueryParser.XqContext ctx, List<String> vars, List<XQueryParser.XqContext> xqs) {
        List<Node> res = new ArrayList<>();
        // base case
        if (idx == vars.size()) {
    ...
    public boolean visitConditon(XQueryParser.CondContext ctx) {
        if (ctx == null) {
            System.out.println("Condition context is null!");
            return false;
        }
        ...
        // Rule 33
            ...
            XQueryParser.CondContext cond = ctx.cond(0);
            if (cond == null) {
                return false;
            }
    ...
    boolean visitSomeCondition(int idx, List<String> vars, List<XQueryParser.XqContext> xqs,
                               XQueryParser.CondContext cond, Map<String, List<Node>> temp) {
        if (idx == vars.size()) {
